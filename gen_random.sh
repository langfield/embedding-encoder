...
srun -J genrand --mem 10000 -c 10 -w osmium python3 rand_vecs.py /data/data26/scratch/user/pretrained-embeddings/GoogleNews-vectors-negative300.bin Word2Vec
